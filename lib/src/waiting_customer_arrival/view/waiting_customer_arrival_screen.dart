...
class WaitingCustomerArrivalScreen extends StatelessWidget {
  const WaitingCustomerArrivalScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: 'انتظار حضور العميل'),
      body: ListView(
        children: const [
          SizedBox(height: 20),
          RentalRequestCard(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomTextField(
            ...
            label: 'يجب الحصول على رقم التفعيل من العميل',
            suffixIcon: SizedBox(
              width: 150,
              child: CustomButton(
                ...
                body: Text(
                  'تأكيد تسليم السيارة',
                  style: TextStyles.style12.copyWith(color: ColorName.white),
                ),
              ),
            ),
          ),
          ...
          SizedBox(
            ...
            child: CustomButton(
              ...
              foregroundColor: ColorName.downriver.withOpacity(.25),
          ...
          const SizedBox(height: 8),
          Text(
            'يمكن الغاء الطلب في حالة عدم حضور العميل في الوقت المحدد فقط',
